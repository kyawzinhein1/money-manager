...
export const BUILD_HASH = 'v2.1.9-20260817';

export const LOCAL_VERSION_INFO: AppVersionInfo = {
  version: 'v2.1.9',
  buildHash: 'v2.1.9-20260817',
  buildTime: '2026-08-17 14:00:00',
  titleEn: 'Release v2.1.9: Weekly & Monthly Analysis Charts and Myanmar Language PDF Statement Export',
  titleMy: 'ဗားရှင်းအသစ် v2.1.9: အပတ်စဉ်နှင့် လစဉ် သုံးသပ်ချက် ဇယားများနှင့် မြန်မာဘာသာ PDF အစီရင်ခံစာ ထုတ်ယူမှု မွမ်းမံချက်',
  changelogEn: [
    'Added interactive Weekly Analysis chart with Income vs Expense and Net Cash Flow toggle views',
    'Added Month-over-Month comparative Analysis chart with localized date headers and top savings statistics',
    'Implemented high-resolution Myanmar language PDF financial report exports with full Unicode font support and localized summaries'
  ],
  changelogMy: [
    'အပတ်စဉ် ဝင်ငွေ/ထွက်ငွေနှင့် အသားတင် စုဆောင်းငွေ စီးဆင်းမှုတို့ကို ပြသပေးသော အပတ်စဉ် သုံးသပ်ချက်ဇယား ထည့်သွင်းပေးခဲ့ပါသည်',
    'လအလိုက် ငွေကြေးသုံးစွဲမှု နှိုင်းယှဉ်ချက်နှင့် ထိပ်တန်းစုဆောင်းနိုင်သောလများကို ဖော်ပြပေးသည့် လစဉ် သုံးသပ်ချက်ဇယား ထည့်သွင်းပေးခဲ့ပါသည်',
    'အက်ပ်ဘာသာစကား မြန်မာဖြစ်ပါက မြန်မာယူနီကုဒ်ဖြင့် တိကျသပ်ရပ်စွာ ထုတ်ယူနိုင်သော PDF အစီရင်ခံစာစနစ်ကို အဆင့်မြှင့်တင်ပေးခဲ့ပါသည်'
  ],
  releaseHistory: [
    {
      version: 'v2.1.9',
